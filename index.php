                                        ...
                                        <ul class="menu">
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="current-item"><a href="home2.html">Home 02</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item">
                    ...
                    <div class="inner-sidebar side-menu__block-inner fl-st-1">
                        <div class="side-menu__top justify-content-end">
                            <a href="#" class="side-menu__toggler side-menu__close-btn"><img
                                    src="assets/images/common/close.png" alt="images"></a>
                        </div>
                        <div class="wrap">
                                ...
                                <div class="themesflat-carousel clearfix" data-margin="30" data-item="1" data-item2="1"
                                    ...
                                    <div class="owl-carousel owl-theme none dots-none">
                                        <div class="item-slider-2">
                                            ...
                                            <div class="box-feature">
                                                <div class="image"><img src="assets/images/common/slider-2.jpg"
                                                        alt="Image"></div>
                                            </div>
                                        </div>
                                        <div class="item-slider-2">
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-7 col-md-12 col-12">
                            <div class="feature-about2">
                                <img src="assets/images/common/sc-aboutus-2.jpg" alt="Image"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="sc-service st-3 fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="800ms">
                                <div class="box-feature inner-scale"><img src="assets/images/common/sc-service-1.jpg"
                                        alt="Image"></div>
                                <div class="box-content">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="sc-service st-4 fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="1000ms">
                                <div class="box-feature inner-scale"><img src="assets/images/common/sc-service-2.jpg"
                                        alt="Image"></div>
                                <div class="box-content">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="sc-service fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="1200ms">
                                <div class="box-feature inner-scale"><img src="assets/images/common/sc-service-3.jpg"
                                        alt="Image"></div>
                                <div class="box-content">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="sc-service st-2 fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="1400ms">
                                <div class="box-feature inner-scale"><img src="assets/images/common/sc-service-4.jpg"
                                        alt="Image"></div>
                                <div class="box-content">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="sc-service st-3 fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="800ms">
                                <div class="box-feature inner-scale"><img src="assets/images/common/sc-service-5.jpg"
                                        alt="Image"></div>
                                <div class="box-content">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="sc-service st-4 fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="1000ms">
                                <div class="box-feature inner-scale"><img src="assets/images/common/sc-service-6.jpg"
                                        alt="Image"></div>
                                <div class="box-content">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="sc-service fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="1200ms">
                                <div class="box-feature inner-scale"><img src="assets/images/common/sc-service-7.jpg"
                                        alt="Image"></div>
                                <div class="box-content">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="sc-service st-2 fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="1400ms">
                                <div class="box-feature inner-scale"><img src="assets/images/common/sc-service-8.jpg"
                                        alt="Image"></div>
                                <div class="box-content">
                                        ...
                                        <div class="owl-carousel owl-theme none">
                                            <div class="item-quote" data-dot="">
                                                <div class="heading">
                                                    <div class="left fx">
                                                        <div class="box-avt">
                                                            <img src="assets/images/thumbnails/avt-quote.jpg"
                                                                alt="Image">
                                                        </div>
                                                        <ul>
                                                            <li>
                                            ...
                                            <div class="item-quote" data-dot="">
                                                <div class="heading">
                                                    <div class="left fx">
                                                        <div class="box-avt">
                                                            <img src="assets/images/thumbnails/avt-quote4.jpg"
                                                                alt="Image">
                                                        </div>
                                                        <ul>
                                                            <li>
                                            ...
                                            <div class="item-quote" data-dot="">
                                                <div class="heading">
                                                    <div class="left fx">
                                                        <div class="box-avt">
                                                            <img src="assets/images/thumbnails/avt-quote5.jpg"
                                                                alt="Image">
                                                        </div>
                                                        <ul>
                                                            <li>
                                            ...
                                            <div class="item-quote" data-dot="">
                                                <div class="heading">
                                                    <div class="left fx">
                                                        <div class="box-avt">
                                                            <img src="assets/images/thumbnails/avt-quote6.jpg"
                                                                alt="Image">
                                                        </div>
                                                        <ul>
                                                            <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                            <div class="box-artice fl-scale st-2 wow fadeIn animated" data-wow-delay="0.3ms"
                                ...
                                <div class="box-feature inner-scale"><a href="blog-single.html"><img
                                            src="assets/images/post/box-aricle1.jpg" alt="Image"></a></div>
                                <div class="box-content">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                            <div class="box-artice fl-scale st-2 wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="1200ms">
                                <div class="box-feature inner-scale"><a href="blog-single.html"><img
                                            src="assets/images/post/box-aricle2.jpg" alt="Image"></a></div>
                                <div class="box-content">
                                    <div class="meta-post st-1">
                                        <ul class="fx">
                                            <li><a href="blog-single.html" class="fx"><i
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                            <div class="box-artice fl-scale st-2 wow fadeIn animated" data-wow-delay="0.3ms"
                                data-wow-duration="1200ms">
                                <div class="box-feature inner-scale"><a href="blog-single.html"><img
                                            src="assets/images/post/box-aricle3.jpg" alt="Image"></a></div>
                                <div class="box-content">
                                    <div class="meta-post st-1">
                                        <ul class="fx">
                                            <li><a href="blog-single.html" class="fx"><i
                                ...
                                <div class="widget-footer">
                                    <div class="widget widget-logo">
                                        <div class="logo-bottom" id="logo-footer">
                                            <a href="index.html"><img src="assets/images/logo/logofootert.png"
                                                    alt="kinco"></a>
                                        </div>
                                    ...
                                    <div class="widget widget-news st-3">
                                        ...
                                        <ul class="list-news">
                                            <li class="fx">
                                                <img src="assets/images/thumbnails/widget9.jpg" alt="Image"
                                                    class="feature">
                                                <ul class="box-content">
                                                    <li>
                                            ...
                                            <li class="fx">
                                                <img src="assets/images/thumbnails/widget10.jpg" alt="Image"
                                                    class="feature">
                                                <ul class="box-content">
                                                    <li>
                                                        <h6 class="title"><a href="blog-grid.html">Useful Code Extened
