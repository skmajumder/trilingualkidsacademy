<section class="tf-section tf-counter">
	<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/pattern/fun-fact-1.png"
	     alt="Image" class="fun-fact1">
	<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/pattern/fun-fact-2.png"
	     alt="Image" class="fun-fact2">
	<div class="container">
		<div class="row">
