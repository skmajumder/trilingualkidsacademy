        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="sc-service st-3 fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                    ...
                    <div class="box-feature inner-scale"><img
                                src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/common/sc-service-1.jpg"
                                alt="Image"></div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="sc-service st-4 fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                    ...
                    <div class="box-feature inner-scale"><img
                                src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/common/sc-service-2.jpg"
                                alt="Image"></div>
                    <div class="box-content">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="sc-service fl-scale wow fadeIn animated" data-wow-delay="0.3ms"
                    ...
                    <div class="box-feature inner-scale"><img
                                src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/common/sc-service-3.jpg"
                                alt="Image"></div>
                    <div class="box-content">
